  ...
  return {
    visitor: {
      ...
      ClassExpression: function ClassExpression(classPath) {
        ...
        [].concat((0, _toConsumableArray2["default"])(decorators._methods_), [decorators._constructor_]).forEach(function (expressions) {
          expressions.reverse().forEach(function (expression) {
